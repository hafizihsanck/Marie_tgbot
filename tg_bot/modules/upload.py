...
from tg_bot import telethn as bot
from tg_bot.modules.urluploader import download_file
from tg_bot.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By @Marie_tgbot",
            )
        except Exception as e:
            traceback.print_exc()
